...
parser.add_option('--plot-only',action="store_true",help="just make the plot")
...
def main():
    ...
    if options.plot_only:
        zphot.weighting.make_pofz_correction(pzrun,plot_only=True)
    else:
